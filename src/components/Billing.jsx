	...
	<section id='product' className={layout.sectionReverse}>
		...
		<div className={layout.sectionInfo}>
			...
			<div className='flex flex-row felx-wrap sm:mt-10 mt-6'>
				<img src={apple} alt='apple_store' className='w-[8rem] h-[3rem] object-contain mr-5 cursor-pointer' />
				<img src={google} alt='google_play' className='w-[8rem] h-[3rem] object-contain mr-5 cursor-pointer' />
			</div>
		</div>
	</section>
);
