...
const Hero = () => (
	<section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
		<div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
			<div className='flex flex-row items-center py-[.375rem] px-4 bg-discount-gradient rounded-[10px] mb-2'>
			...
			<div className='flex flex-row justify-between items-center w-full'>
				<h1 className='flex-1 font-poppins font-semibold ss:text-[4.5rem] text-[3.25rem] text-white ss:leading-[100.8px] leading-[75px]'>
			...
			<h1 className='font-poppins font-semibold ss:text-[4.25rem] text-[3.25rem] text-white ss:leading-[100.8px] leading-[75px] w-full'>
				Payment Method.
			</h1>
		...
		<div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
			<img src={robot} alt='hand' className='w-[100%] h-[100%] relative z-[5]' />
